    ...
    <div class="inputtop mb-4">
      ...
      <div className="mb-4 field">
        ...
        <input type="date" id="date" name="date" value={date}
          onChange={(e) => setDate(e.target.value)} class="date px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black-500" required>
        </input>
      </div>
      <div className="addexpense">
      <button type="submit" class="mr-4 w-half bg-violet text-white py-2 px-4 rounded-lg hover:bg-violet focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">Add Expense</button>
      </div>
    </form>
  </div> 
    </> );
